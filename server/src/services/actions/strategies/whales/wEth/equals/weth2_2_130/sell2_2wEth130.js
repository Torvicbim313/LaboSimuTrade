...
const sell2_2weth130 = async () => {

  const db = await pool.getConnection();
  
  try {

    // Obtener el último valor de eth de '2_2tardes_ballenas'
    ...
    console.log("USDC después de vender en 2_2_130 (con comisión y gas):", usdtAfterSell);
