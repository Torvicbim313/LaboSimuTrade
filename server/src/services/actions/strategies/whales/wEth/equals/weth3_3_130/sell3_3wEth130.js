...
const sell3_3weth130 = async () => {
  ...
  try {
    ...
    const [ethAmountResult] = await db.query(
      "SELECT eth_amount FROM 3_3weth130 ORDER BY id DESC LIMIT 1"
    );
    ...
    console.log("USDC después de vender en 3_3_130 (con comisión y gas):", usdtAfterSell);
