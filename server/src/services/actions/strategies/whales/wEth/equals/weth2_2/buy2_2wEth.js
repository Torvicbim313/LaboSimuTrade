...
const buy2_2wEth = async () => {
    ...
    try {
        ...
        if (!lastRow) {
            console.error("No hay registros previos en 2_2weth.");
            return;
        }
        ...
        if (previousWethAmount * 1.02 < ethItCanPurchase && ethItCanPurchase < previousWethAmount * 3) {
            ...
            await takeProfit2_2wEth(ethItCanPurchase, buyPriceethUni, sellPriceethUni);
        ...
        if (previousWethAmount > ethItCanPurchase * 1.02) {
            ...
            await stopLoss2_2wEth(ethItCanPurchase, buyPriceethUni, sellPriceethUni);
        }
        ...
        console.error("Error intentando registrar compra en 2_2weth:", error);
    } finally {
