...
import takeProfit3_3weth130 from "./takeProfit3_3wEth130.js";
import stopLoss3_3weth130 from "./stopLoss3_3wEth130.js";
...
const buy3_3weth130 = async () => {
    ...
    try {
        ...
        if (!lastRow) {
            console.error("No hay registros previos en 3_3weth130.");
            return;
        }
        ...
        console.error("Error intentando registrar compra en 3_3weth130:", error);
    } finally {
        db.release();  // IMPORTANTE: liberar la conexión después de usarla
    }
};

export default buy3_3weth130;
